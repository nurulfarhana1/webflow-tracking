...
function tracking_data_mappping(data) {
  // console.log(data);
  if (data.serviceProvider === "ninjavan") {
    $("#provider_logo").attr(
      "src",
    ...
    tracking_data_mapping2_ninjavan(data);
  }
  if (data.serviceProvider === "poslaju") {
    $("#provider_logo").attr(
      "src",
  ...
  if (data.serviceProvider === "citylink") {
    $("#provider_logo").attr(
      "src",
  ...
  if (data.serviceProvider === "pickupp") {
    $("#provider_logo").attr(
      "src",
  ...
  if (data.serviceProvider === "teleport") {
    $("#provider_logo").attr(
      "src",
  ...
  if (data.serviceProvider === "sfstandard") {
    $("#provider_logo").attr(
      "src",
  ...
  if (data.serviceProvider === "lineclear") {
    $("#provider_logo").attr(
      "src",
  ...
  if (data.serviceProvider === "aramex") {
    $("#provider_logo").attr(
      "src",
...
function tracking_data_mapping2_ninjavan(data) {
  ...
  $("#provider_title").text(data.serviceProvider);
  $("#provider_shortcode").text(data.serviceProvider);
  $("#tracking_no").text(data.consign_no);
